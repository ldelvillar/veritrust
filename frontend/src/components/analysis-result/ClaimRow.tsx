    ...
    <div className="flex gap-3 border-t border-line py-4 first:border-t-0 first:pt-0.5 print:break-inside-avoid">
      ...
      <div className="min-w-0 flex-1">
        ...
        <div className="mt-2 flex flex-wrap items-center gap-2.5">
          <span
            className={`rounded-md px-2 py-1 text-2xs font-bold tracking-wide uppercase ${style.pill}`}
          >
            {style.text}
          </span>
        ...
        {showEvidence &&
          (sourceCount > 0 ? (
            <>
              <div className="mt-3 flex flex-wrap items-center gap-x-4 gap-y-2">
                <button
                  ...
                  className="inline-flex items-center gap-1.5 rounded-lg border border-primary/20 bg-primary/5 px-2.5 py-1.5 text-xs font-bold text-primary transition hover:bg-primary/10 focus:ring-2 focus:ring-primary/20 focus:outline-none print:hidden"
                >
                ...
                {stanceItems.length > 0 && (
                  <span className="inline-flex flex-wrap items-center gap-x-3 gap-y-1 text-2xs font-semibold text-faint">
            ...
            <p className="mt-3 flex items-center gap-2 text-xs font-medium text-faint">
