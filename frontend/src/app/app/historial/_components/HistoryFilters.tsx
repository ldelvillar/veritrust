  ...
  return (
    <div className="mb-4 grid grid-cols-1 gap-3 lg:grid-cols-[1fr_auto_auto_auto_auto_auto]">
      <label className="relative block">
        ...
        <Magnifier className="pointer-events-none absolute top-1/2 left-3 size-4 -translate-y-1/2 text-faint" />
        <input
          type="text"
          value={searchQuery}
          onChange={event => onSearchQueryChange(event.target.value)}
          placeholder="Buscar artículos por título o palabra clave"
          className="h-11 w-full rounded-xl border border-border bg-white pl-10 text-sm text-body transition-all outline-none placeholder:text-faint hover:border-primary/50 focus:border-primary focus:ring-2 focus:ring-primary/10"
        />
      </label>
      ...
      <label className="relative block">
        <select
          ...
          className="h-11 w-full min-w-48 cursor-pointer appearance-none rounded-xl border border-border bg-white px-4 pr-10 text-sm font-medium text-body transition-all outline-none hover:border-primary/50 focus:border-primary focus:ring-2 focus:ring-primary/10"
        >
      ...
      <label className="relative block">
        <select
          ...
          className="h-11 w-full min-w-56 cursor-pointer appearance-none rounded-xl border border-border bg-white px-4 pr-10 text-sm font-medium text-body transition-all outline-none hover:border-primary/50 focus:border-primary focus:ring-2 focus:ring-primary/10"
        >
