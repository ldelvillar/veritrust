...
export default function HelpContactStrip({ email }: HelpContactStripProps) {
  return (
    <div className="relative mt-10 mb-4 overflow-hidden rounded-2xl bg-primary px-8 py-8 text-white shadow-[0_16px_40px_rgba(12,79,82,.26)] md:flex md:items-center md:gap-8 md:px-9">
      ...
      <div className="relative z-10 flex-1">
        ...
        <p className="mt-1.5 max-w-105 text-sm leading-relaxed font-medium text-white/85">
