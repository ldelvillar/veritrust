  ...
  return (
    <section className="mx-auto flex w-full max-w-7xl flex-1 flex-col gap-5 px-4 py-8 md:px-6 lg:py-10">
        ...
        <div className="flex flex-col gap-2.25">
          ...
          <div className="grid grid-cols-1 gap-4 lg:grid-cols-2">
            {Array.from({ length: 2 }, (_, i) => (
              <div
                key={i}
                className="flex items-center gap-5 rounded-2xl border border-line bg-white p-5.5 shadow-[0_1px_2px_rgba(18,33,31,.05),0_10px_30px_rgba(18,33,31,.06)]"
              >
                <Sk className="size-11.5 shrink-0 rounded-xl" />
                <div className="flex flex-1 flex-col gap-2.5">
                  <Sk className="h-2.75 w-[48%] rounded-md" />
                  <Sk className="h-9.5 w-24 rounded-lg" />
        ...
        <div className="flex flex-col gap-2.25">
          ...
          <div className="grid grid-cols-1 gap-4 sm:grid-cols-2 xl:grid-cols-3">
            {Array.from({ length: 3 }, (_, i) => (
              <div
                key={i}
                className="flex flex-col gap-2.75 rounded-2xl border border-line bg-white p-5 shadow-[0_1px_2px_rgba(18,33,31,.05),0_10px_30px_rgba(18,33,31,.06)]"
              >
                <div className="flex items-center gap-2.75">
                  <Sk className="size-8.5 shrink-0 rounded-lg" />
                  <Sk className="h-2.75 w-[62%] rounded-md" />
                </div>
                <Sk className="h-7.5 w-18.5 rounded-lg" />
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-[1.62fr_1fr]">
        <div className="flex flex-col rounded-2xl border border-line bg-white p-6 shadow-[0_1px_2px_rgba(18,33,31,.05),0_10px_30px_rgba(18,33,31,.06)]">
          <div className="mb-5">
            <Sk className="mb-2.5 h-4.5 w-40 rounded-lg" />
            <Sk className="h-3 w-60 rounded-md" />
          </div>
          <Sk className="h-67.5 w-full rounded-xl" />
        </div>

        <div className="flex flex-col rounded-2xl border border-line bg-white p-6 shadow-[0_1px_2px_rgba(18,33,31,.05),0_10px_30px_rgba(18,33,31,.06)]">
          <div className="mb-5">
            <Sk className="mb-2.5 h-4.5 w-22.5 rounded-lg" />
      ...
      <div className="grid grid-cols-1 gap-5 xl:grid-cols-[1fr_1.1fr]">
        {Array.from({ length: 2 }, (_, col) => (
          <div
            key={col}
            className="flex flex-col rounded-2xl border border-line bg-white p-6 shadow-[0_1px_2px_rgba(18,33,31,.05),0_10px_30px_rgba(18,33,31,.06)]"
          >
            <div className="mb-5">
              <Sk className="mb-2.5 h-4.5 w-37.5 rounded-lg" />
            ...
            {Array.from({ length: 3 }, (_, i) => (
              ...
              >
                <Sk className="size-9.5 shrink-0 rounded-xl" />
